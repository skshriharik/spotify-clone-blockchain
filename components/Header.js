  ...
  return  (
    <div className={style.header}>
      <div className={style.headerWrapper}>
        <div className='flex items-center'>
          <div className={style.arrowButton}>
            <Image alt='' src='/assets/chevronLeft.svg' width={20} height={20} />
          </div>
          <div className={style.arrowButton}>
            <Image alt='' src='/assets/chevronRight.svg' width={20} height={20} />
          </div>
        </div>
      ...
      <div className={style.playlistTextContent}>
        ...
        <div className='ml-5'>
          <div>ALBUM</div>
          <div className={style.title}>Adhoora</div>
